            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                        <input wire:model="search" type="text" class="form-control" id="topbarInputIconLeft"
                                    ...
                                    <tr>
                                        <td><a href="#" class="d-flex align-items-center"><img
                                                ...
                                                <div class="d-block"><span
                                                        class="fw-bold">{{ $member->namadepan }}{{ $member->namabelakang }}</span>
                                        ...
                                        <td>
                                            <div class="btn-group"><button
                                                    ...
                                                    aria-expanded="false"><svg class="icon icon-xs" fill="currentColor"
                                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            </div><svg class="icon icon-xs text-danger ms-1" title=""
                                                data-bs-toggle="tooltip" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg" data-bs-original-title="Delete"
                                                aria-label="Delete">
                                                <path fill-rule="evenodd"
